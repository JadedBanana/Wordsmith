...
execute if score #permutation_step vars matches 1 if score #red_players_now vars matches ..0 run function wordsmith:turn/permutations/p28
execute unless score #permutation_depth vars matches 2.. if score #permutation_step vars matches 0 if score #blue_players_now vars matches ..0 run function wordsmith:turn/permutations/p28
