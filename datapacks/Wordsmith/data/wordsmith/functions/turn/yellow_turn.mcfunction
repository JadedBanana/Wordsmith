...
execute if score #teams vars matches 2.. run function wordsmith:turn/yellow_title_versus
execute unless score #teams vars matches 2.. run function wordsmith:turn/yellow_title_endurance
...
scoreboard players set #team_turn vars 3
...
bossbar set minecraft:3 visible true
...
function wordsmith:turn/bossbar/yellow_directory