...
execute if score #teams vars matches 2.. run function wordsmith:turn/green_title_versus
execute unless score #teams vars matches 2.. run function wordsmith:turn/green_title_endurance
...
scoreboard players set #team_turn vars 2
...
function wordsmith:turn/bossbar/green_directory