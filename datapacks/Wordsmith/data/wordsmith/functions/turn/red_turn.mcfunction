...
execute if score #teams vars matches 2.. run function wordsmith:turn/red_title_versus
execute unless score #teams vars matches 2.. run function wordsmith:turn/red_title_endurance
...
scoreboard players set #team_turn vars 0
...
function wordsmith:turn/bossbar/red_directory