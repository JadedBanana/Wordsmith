...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/respawn_anchor4
execute if score #required_letter vars matches 18 run function wordsmith:detect/words/respawn_anchor4