...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/redstone_lamp4
execute if score #required_letter vars matches 18 run function wordsmith:detect/words/redstone_lamp4