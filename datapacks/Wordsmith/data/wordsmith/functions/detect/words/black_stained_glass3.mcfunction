...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/black_stained_glass4
execute if score #required_letter vars matches 2 run function wordsmith:detect/words/black_stained_glass4