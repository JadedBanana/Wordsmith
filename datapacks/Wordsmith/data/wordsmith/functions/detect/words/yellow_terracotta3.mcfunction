...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/yellow_terracotta4
execute if score #required_letter vars matches 25 run function wordsmith:detect/words/yellow_terracotta4