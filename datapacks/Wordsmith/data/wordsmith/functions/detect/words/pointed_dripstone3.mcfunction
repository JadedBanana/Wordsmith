...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/pointed_dripstone4
execute if score #required_letter vars matches 16 run function wordsmith:detect/words/pointed_dripstone4