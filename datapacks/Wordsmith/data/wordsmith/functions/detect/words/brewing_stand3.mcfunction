...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/brewing_stand4
execute if score #required_letter vars matches 2 run function wordsmith:detect/words/brewing_stand4