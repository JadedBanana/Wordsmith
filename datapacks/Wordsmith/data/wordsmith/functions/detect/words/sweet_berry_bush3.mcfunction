...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/sweet_berry_bush4
execute if score #required_letter vars matches 19 run function wordsmith:detect/words/sweet_berry_bush4