...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/elder_guardian4
execute if score #required_letter vars matches 5 run function wordsmith:detect/words/elder_guardian4