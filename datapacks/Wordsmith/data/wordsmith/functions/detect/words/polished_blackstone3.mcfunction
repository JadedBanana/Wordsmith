...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/polished_blackstone4
execute if score #required_letter vars matches 16 run function wordsmith:detect/words/polished_blackstone4