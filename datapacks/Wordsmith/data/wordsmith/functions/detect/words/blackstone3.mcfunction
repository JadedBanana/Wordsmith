...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/blackstone4
execute if score #required_letter vars matches 2 run function wordsmith:detect/words/blackstone4