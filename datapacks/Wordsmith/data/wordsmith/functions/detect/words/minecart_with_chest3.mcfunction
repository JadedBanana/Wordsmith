...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/minecart_with_chest4
execute if score #required_letter vars matches 13 run function wordsmith:detect/words/minecart_with_chest4