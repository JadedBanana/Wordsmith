...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/end_rod4
execute if score #required_letter vars matches 5 run function wordsmith:detect/words/end_rod4