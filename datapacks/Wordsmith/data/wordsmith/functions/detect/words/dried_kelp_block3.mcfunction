...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/dried_kelp_block4
execute if score #required_letter vars matches 4 run function wordsmith:detect/words/dried_kelp_block4