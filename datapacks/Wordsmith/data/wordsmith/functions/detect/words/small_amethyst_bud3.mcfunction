...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/small_amethyst_bud4
execute if score #required_letter vars matches 19 run function wordsmith:detect/words/small_amethyst_bud4