...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/quarter_moon4
execute if score #required_letter vars matches 17 run function wordsmith:detect/words/quarter_moon4