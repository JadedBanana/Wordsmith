...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/lapis_lazuli_block4
execute if score #required_letter vars matches 12 run function wordsmith:detect/words/lapis_lazuli_block4