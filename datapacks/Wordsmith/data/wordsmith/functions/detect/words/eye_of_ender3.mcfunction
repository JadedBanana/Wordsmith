...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/eye_of_ender4
execute if score #required_letter vars matches 5 run function wordsmith:detect/words/eye_of_ender4