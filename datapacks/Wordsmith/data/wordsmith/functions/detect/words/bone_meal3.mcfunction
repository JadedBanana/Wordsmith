...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/bone_meal4
execute if score #required_letter vars matches 2 run function wordsmith:detect/words/bone_meal4