...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/soul_lantern4
execute if score #required_letter vars matches 19 run function wordsmith:detect/words/soul_lantern4