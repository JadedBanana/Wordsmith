...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/dark_oak_leaves4
execute if score #required_letter vars matches 4 run function wordsmith:detect/words/dark_oak_leaves4