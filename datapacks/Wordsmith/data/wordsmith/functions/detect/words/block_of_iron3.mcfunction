...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/block_of_iron4
execute if score #required_letter vars matches 2 run function wordsmith:detect/words/block_of_iron4