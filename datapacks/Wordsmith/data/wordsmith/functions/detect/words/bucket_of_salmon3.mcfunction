...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/bucket_of_salmon4
execute if score #required_letter vars matches 2 run function wordsmith:detect/words/bucket_of_salmon4