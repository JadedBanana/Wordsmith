...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/bad_omen4
execute if score #required_letter vars matches 2 run function wordsmith:detect/words/bad_omen4