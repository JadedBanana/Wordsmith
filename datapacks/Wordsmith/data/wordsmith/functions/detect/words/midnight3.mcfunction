...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/midnight4
execute if score #required_letter vars matches 13 run function wordsmith:detect/words/midnight4