...
execute if score #required_letter vars matches 0 run function wordsmith:detect/words/dead_coral4
execute if score #required_letter vars matches 4 run function wordsmith:detect/words/dead_coral4