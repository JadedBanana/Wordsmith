...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run setblock ~ ~ ~ minecraft:blue_shulker_box[facing=north]{"Lock": "haha nice try motherfucker cant open this shit. not even if you tried. good luck dipshit"}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run setblock ~ ~ ~ minecraft:blue_shulker_box[facing=east]{"Lock": "haha nice try motherfucker cant open this shit. not even if you tried. good luck dipshit"}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run setblock ~ ~ ~ minecraft:blue_shulker_box[facing=south]{"Lock": "haha nice try motherfucker cant open this shit. not even if you tried. good luck dipshit"}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=3}] run setblock ~ ~ ~ minecraft:blue_shulker_box[facing=west]{"Lock": "haha nice try motherfucker cant open this shit. not even if you tried. good luck dipshit"}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=4}] run setblock ~ ~ ~ minecraft:blue_shulker_box[facing=up]{"Lock": "haha nice try motherfucker cant open this shit. not even if you tried. good luck dipshit"}
