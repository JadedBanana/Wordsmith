...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"north"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"east"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"south"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=3}] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"west"}},Time:1}
...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"north"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"east"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"south"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=3}] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:birch_stairs",Properties:{facing:"west"}},Time:1}
