...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:yellow_terracotta"},Time:1}
...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:yellow_terracotta"},Time:1}
