...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:acacia_log",Properties:{axis:"x"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:acacia_log",Properties:{axis:"y"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:acacia_log",Properties:{axis:"z"}},Time:1}
...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:acacia_log",Properties:{axis:"x"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:acacia_log",Properties:{axis:"y"}},Time:1}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:acacia_log",Properties:{axis:"z"}},Time:1}
