...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner] run summon falling_block ~ ~10 ~ {BlockState:{Name:"minecraft:light_blue_stained_glass"},Time:1}
...
# Summon block
execute at @e[type=minecraft:armor_stand,tag=spawner] run summon falling_block ~ ~12 ~ {BlockState:{Name:"minecraft:light_blue_stained_glass"},Time:1}
