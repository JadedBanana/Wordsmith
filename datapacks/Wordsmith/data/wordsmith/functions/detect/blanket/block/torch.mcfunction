...
execute store result score #blocks_killed3 vars run kill @e[type=minecraft:falling_block,nbt={BlockState:{Name:"minecraft:wall_torch"}}]
execute store result score #blocks_killed4 vars run kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:soul_torch"}}]
execute store result score #blocks_killed5 vars run kill @e[type=minecraft:falling_block,nbt={BlockState:{Name:"minecraft:soul_torch"}}]
execute store result score #blocks_killed6 vars run kill @e[type=minecraft:falling_block,nbt={BlockState:{Name:"minecraft:soul_wall_torch"}}]
execute store result score #blocks_killed7 vars run kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:redstone_torch"}}]
execute store result score #blocks_killed8 vars run kill @e[type=minecraft:falling_block,nbt={BlockState:{Name:"minecraft:redstone_torch"}}]
execute store result score #blocks_killed9 vars run kill @e[type=minecraft:falling_block,nbt={BlockState:{Name:"minecraft:redstone_wall_torch"}}]
