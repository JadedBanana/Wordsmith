...
# Summon item
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon item ~ ~10 ~ {Item:{id:"minecraft:splash_potion",tag:{Potion:"minecraft:healing"},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon item ~ ~10 ~ {Item:{id:"minecraft:splash_potion",tag:{Potion:"minecraft:strong_healing"},Count:1b}}
...
# Summon item
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon item ~ ~12 ~ {Item:{id:"minecraft:splash_potion",tag:{Potion:"minecraft:healing"},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon item ~ ~12 ~ {Item:{id:"minecraft:splash_potion",tag:{Potion:"minecraft:strong_healing"},Count:1b}}
