...
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon item ~ ~10 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:1s}]},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon item ~ ~10 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:2s}]},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run summon item ~ ~10 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:3s}]},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=3}] run summon item ~ ~10 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:4s}]},Count:1b}}
...
# Summon enchanted book
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run summon item ~ ~12 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:1s}]},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run summon item ~ ~12 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:2s}]},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run summon item ~ ~12 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:3s}]},Count:1b}}
execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=3}] run summon item ~ ~12 ~ {Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:protection", lvl:4s}]},Count:1b}}
