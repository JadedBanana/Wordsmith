...
# Summon item
execute at @e[type=minecraft:armor_stand,tag=spawner] run summon item ~ ~10 ~ {Item:{id:"minecraft:diamond_axe",Count:1b}}
...
# Summon item
execute at @e[type=minecraft:armor_stand,tag=spawner] run summon item ~ ~12 ~ {Item:{id:"minecraft:diamond_axe",Count:1b}}
